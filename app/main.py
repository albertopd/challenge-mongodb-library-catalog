...
def main():
    ...
    try:
        ...
        db_name = os.getenv("MONGO_DB_NAME", "library_catalog")
        ...
        with MongoDbLibraryCatalog(
            ...
            if catalog.is_empty():
                ...
                books_count = catalog.populate_from_csv(csv_path)
                if books_count:
            ...
            for book in books_by_author:
                print(f"- \"{book['title']}\" published on {book['publishYear']}")
            ...
            if book:
                ...
                if updated_book:
                    ...
                    print_ratings(updated_book)
                else:
                    print("Failed to update book ratings.")
